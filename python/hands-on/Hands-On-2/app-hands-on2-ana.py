...
@app.route("/admin")
def admin():
    return redirect(url_for("error"))    # redirection Önemli bir olay


# Create a function named greet which return formatted inline html string 
# and assign to the dynamic route of ('/<name>')

#@app.route("/<isim>")          # Bu blok normal çözüm alttaki html'li alternatifi
#def greet(isim):
#    return f"Hello, {isim}"
...
<body>
    <h1>Hello, { isim }!</h1>
    <h1>Welcome to my Greeting Page Normal</h1>
</body>
</html>
    """
    return greet_format
...
@app.route('/evens')           # Burada alternatif çözümleri dene, mesela
                     # html'den değil de return render_template("evens.html", list = [i for i in range(1,11) if i % 2 == 0])
def evens():
