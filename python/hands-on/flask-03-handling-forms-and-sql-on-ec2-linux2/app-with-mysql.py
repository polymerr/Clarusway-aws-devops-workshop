...
# Configure mysql database  Burada kendi makinenin endpointini gir
app.config['MYSQL_DATABASE_HOST'] = 'database-1.cbshdaeged3f.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'polo5902'
